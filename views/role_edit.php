            ...
            <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-lg">
                ...
                <form action="index.php?modul=role&fitur=edit&id=<?php echo $role->role_id ?>" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="role_name" name="role_name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Masukkan Nama Role" required value="<?php echo htmlspecialchars($role->role_name) ?>">
                    </div>

                    <!-- Role Deskripsi -->
                    <div class="mb-4">
                        <label for="role_description" class="block text-gray-700 text-sm font-bold mb-2">Role Deskripsi:</label>
                        <textarea id="role_description" name="role_description" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Masukkan Deskripsi Role" rows="3" required><?php echo htmlspecialchars($role->role_description) ?></textarea>
                    </div>
